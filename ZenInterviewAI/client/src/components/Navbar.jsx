...
function Navbar() {
  ...
  return (
    <div className='bg-gradient-to-r from-[#e8e3fd]
    to-[#ab9af5]  flex justify-center px-4 pt-6'>
        <motion.div
        initial={{opacity:0,y:-40}}
        animate={{opacity:1,y:0}}
        transition={{duration:0.3}}
         className='w-full max-w-6xl mx-auto bg-white rounded-[24px]
        shadow-sm border border-gray-200 px-8 py-4 flex justify-between items-center relative '>
                 <div className='flex items-center gap-3 cursor-pointer'>
                    <div className='bg-black text-white p-2 rounded-lg'>
                      <BsRobot size={18}/>
                    </div>
                    <h1 className='font-semibold hidden md:block
                    text-lg'>ZenAI.Interview</h1>
                 </div>
                    ...
                    <div className='relative'>
                        ...
                        {showUserPopup && (
                            ...
                            shadow-xl border border-gray-200 rounded-xl p-4 z-50'>
                                ...
                                gap-2 text-red-500'>
                                    <IoLogOut size={16}/>Logout</button>
                            </div>
                        )}
                    </div>
                 </div>
